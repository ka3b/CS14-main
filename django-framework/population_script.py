...
def add_journey(driver, date, destinations, purpose, no_of_pass, start_time, end_time, speedo_start, speedo_finish):
    journey = Journey.objects.get_or_create(driver=driver, date=date, destinations=destinations, purpose=purpose, no_of_pass=no_of_pass, start_time=start_time, end_time=end_time, speedo_start=speedo_start, speedo_finish=speedo_finish)[0]
    journey.save()
    return journey
